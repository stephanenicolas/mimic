...
public class MimicCreator {
	...
	public void mimicMethods(CtClass src, CtClass dst)
			throws CannotCompileException {
	...
	public void mimicConstructors(CtClass src, CtClass dst)
	...
	public void mimicInterfaces(CtClass src, CtClass dst)
			throws NotFoundException {
	...
	public boolean hasInterface(CtClass dst, CtClass interfazz)
			throws NotFoundException {
